...
class XHub {
    ...
    getCategories() {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            try {
                const response = yield axios_1.default.get(`${apiUrl}/categories`, { headers: this.headers });
    ...
    fetch(type) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            try {
                const response = yield axios_1.default.post(`${apiUrl}`, { type }, { headers: this.headers });
                return response.data;
            }
            catch (error) {
